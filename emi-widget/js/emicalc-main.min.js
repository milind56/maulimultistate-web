...
*/
(function(){function p(){a("#ecww-widget-iframeinner").html('<form id="ecww-formwrapper" class="col-xs-12 col-sm-4 no-pad"><div id="ecww-form"><div class="form-group"> <label for="ecww-loanamount" class="control-label">Enter Loan Amount</label> <div class="input-group"> <span class="ecww-addon input-group-addon"><span class="glyphicon glyphicon-rupee"></span></span> <input type="text" class="form-control ecww-userinput" id="ecww-loanamount" value="250,000" tabindex="1" placeholder="Loan Amount"/> </div></div><div class="form-group"> <label for="ecww-loaninterest" class="control-label">Interest Rate</label> <div class="input-group"> <span class="ecww-addon input-group-addon"><span class="glyphicon glyphicon-percent"></span></span> <input type="text" class="form-control ecww-userinput" id="ecww-loaninterest" value="5.25" tabindex="2" placeholder="Interest Rate"/> </div></div><div class="form-group"> <label for="ecww-loanterm" class="control-label">Loan Tenure</label> <div class="form-group"> <div class="ecww-tenure-choice"> <div class="btn-group" data-toggle="buttons"> <label class="btn btn-primary active"> <input type="radio" name="ecww-loantenure" id="ecww-loanyears" tabindex="4" autocomplete="off" checked/>Year </label> <label class="btn btn-primary"> <input type="radio" name="ecww-loantenure" id="ecww-loanmonths" tabindex="5" autocomplete="off"/>Month </label></div></div> <div class="ecww-inline-input-group"> <div class="input-group"> <span class="ecww-addon input-group-addon"><span class="glyphicon glyphicon-time"></span></span> <input type="text" class="form-control ecww-userinput" id="ecww-loanterm" value="15" tabindex="3" placeholder="Loan Tenure"/> </div></div></div></div><div class="clearfix"></div></div></form><div id="ecww-piechart" class="highcharts-container col-xs-12 col-sm-4 no-pad"></div><div id="ecww-summary" class="col-xs-12 col-sm-4 no-pad"><div id="ecww-monthlypayment"><h4>Loan EMI</h4><p>\u20b9 1,24,797</p></div><div id="ecww-totalinterest"><h4>Total Interest Payable</h4><p>\u20b9 34,90,279</p></div><div id="ecww-totalamount"><h4>Total Repayment<br/>(Principal + Interest)</h4><p>\u20b9 59,90,279</p></div></div>');
h={colors:"#ff7717 #802a43 #ED561B #DDDF00 #24CBE5 #64E572 #FF9655 #FFF263 #6AF9C4".split(" "),chart:{backgroundColor:"#FFFFFF",borderWidth:1,borderColor:"#DBDAD7",borderRadius:0,plotBackgroundColor:"#FFFFFF",plotShadow:!1,plotBorderWidth:1,style:{fontFamily:"Helvetica, Arial, Verdana, sans-serif",fontSize:"13px",fontWeight:"normal",color:"#888888"}},tooltip:{style:{color:"#444444",font:"13px Helvetica, Arial, Verdana, sans-serif"}},title:{style:{color:"#444444",font:"bold 13px Helvetica, Arial, Verdana, sans-serif"}},
...
"n0","en-IN")}function q(){a("#ecww-loanamount").val(k(250000));a("#ecww-loaninterest").val(8.5);a("#ecww-form input[name='ecww-loantenure']")[0].checked?a("#ecww-loanterm").val(5):a("#ecww-loanterm").val(240);a(".ecww-userinput").change(function(){l();m();n()})}function l(){e=c("#ecww-loanamount");d=Math.abs(a("#ecww-loaninterest").val()/12/100);b=a("#ecww-form input[name='ecww-loantenure']")[0].checked?Math.abs(Math.round(12*a("#ecww-loanterm").val())):Math.abs(a("#ecww-loanterm").val());0==d&&
